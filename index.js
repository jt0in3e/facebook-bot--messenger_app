...
function createEvent(collection, date, sender) {
	  ...
	  let ex = collection.findOne(queryTest, {"_id":1}); //trying this to find check solution http://stackoverflow.com/questions/8389811/how-to-query-mongodb-to-test-if-an-item-exists
	  if (ex) { 
